  ...
  <header id="main-header" class="py-2 bg-danger text-white">
        <div class="text-align-middle">
          <img src="../image/quizzy.jpg" alt="" class="mx-4 mb-3 mt-4 rounded-circle d-inline" width="100" height="100">
					<span class="display-4"><strong>Quizzy</strong> <span class="display-6 text-dark">Admin Panel</span></strong></span>
					<div class="float-right"><i class="fas fa-user-cog fa-5x "></i></div>
          </div>
  </header> 
